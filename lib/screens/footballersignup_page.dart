...
class _FootballerSignUpPageState extends State<FootballerSignUpPage> {
  ...
  Future<void> _selectDate() async {
    ...
    if (date != null) {
      _dobCtrl.text = '${date.day.toString().padLeft(2, '0')}/'
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      final dobIso = '${dobParts[2]}-${dobParts[1].padLeft(2, '0')}-${dobParts[0].padLeft(2, '0')}';
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: ['Beginner', 'Semi-Pro', 'Professional']
                      .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                      .toList(),
                  onChanged: (val) => setState(() => experience = val),
                  validator: (v) => v == null ? 'Please select experience level' : null,
                ),
